...
import { ROL_PERMISO_REPOSITORY } from './domain/ports/rol_permiso-repository.port';
...
import { RolPermisoController } from './infrastructure/http/controllers/rol_permiso.controller';
