...
import { ProductoAgroController } from './infrastructure/http/producto-agro.controller';
...
@Module({
  ...
  providers: [
    { provide: PRODUCTO_AGRO_REPOSITORY, useClass: ProductoAgroTypeOrmRepository },
