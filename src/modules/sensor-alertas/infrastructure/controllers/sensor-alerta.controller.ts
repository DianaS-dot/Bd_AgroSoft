...
import { UpdateSensorAlertaDto } from '../dto/update-sensor-alerta.dto';
...
export class SensorAlertaController {
  constructor(
    ...
    private readonly actualizarSensorAlerta: ActualizarSensorAlertaUseCase,
  ...
  actualizar(
    ...
    @Body() dto: UpdateSensorAlertaDto,
  ) {
    const alerta = new SensorAlerta({
      id,
      sensorId: dto.sensorId!,
    ...
    return this.actualizarSensorAlerta.ejecutar(alerta);
  }
